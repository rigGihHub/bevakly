...
const aiToolSources: WatchSource[] = [
  {id:'openai-news',name:'OpenAI News',listingUrl:'https://openai.com/news/',baseUrl:'https://openai.com',type:'company',scope:'international',tier:1,trustScore:98,enabled:true,description:'Officiella produktnyheter om ChatGPT, Codex och OpenAI-modeller.'},
  {id:'google-gemini-blog',name:'Google Gemini',listingUrl:'https://blog.google/products/gemini/',baseUrl:'https://blog.google',type:'company',scope:'international',tier:1,trustScore:98,enabled:true,description:'Officiella uppdateringar om Gemini och Googles AI-produkter.'},
  {id:'google-ai-blog',name:'Google AI',listingUrl:'https://blog.google/innovation-and-ai/technology/ai/',baseUrl:'https://blog.google',type:'company',scope:'international',tier:1,trustScore:98,enabled:true,description:'Googles bredare officiella AI-nyheter och lanseringar.'},
  {id:'anthropic-news',name:'Anthropic',listingUrl:'https://www.anthropic.com/news',baseUrl:'https://www.anthropic.com',type:'company',scope:'international',tier:1,trustScore:98,enabled:true,description:'Officiella nyheter om Claude och Anthropics modeller och verktyg.'},
  {id:'microsoft-copilot-blog',name:'Microsoft Copilot',listingUrl:'https://www.microsoft.com/en-us/microsoft-copilot/blog/',baseUrl:'https://www.microsoft.com',type:'company',scope:'international',tier:1,trustScore:97,enabled:true,description:'Officiella produktnyheter om Microsoft Copilot.'},
  {id:'microsoft-official-blog',name:'Microsoft – Official Blog',listingUrl:'https://blogs.microsoft.com/blog/',baseUrl:'https://blogs.microsoft.com',type:'company',scope:'international',tier:2,trustScore:96,enabled:true,description:'Officiella Microsoft-nyheter som fångar större Copilot- och AI-lanseringar.'},
  {id:'perplexity-blog',name:'Perplexity',listingUrl:'https://www.perplexity.ai/hub/blog',baseUrl:'https://www.perplexity.ai',type:'company',scope:'international',tier:1,trustScore:97,enabled:true,description:'Perplexitys officiella produkt-, forsknings- och företagsnyheter.'},
];

const googleWorkspaceSources: WatchSource[] = [
  {id:'google-workspace-updates',name:'Google Workspace Updates',listingUrl:'https://workspaceupdates.googleblog.com/',baseUrl:'https://workspaceupdates.googleblog.com',type:'company',scope:'international',tier:1,trustScore:99,enabled:true,description:'Googles officiella och löpande releaseflöde för Workspace.'},
  {id:'google-workspace-blog',name:'Google Workspace Blog',listingUrl:'https://workspace.google.com/blog/',baseUrl:'https://workspace.google.com',type:'company',scope:'international',tier:1,trustScore:98,enabled:true,description:'Officiella Workspace-nyheter, produktlanseringar och administratörsinformation.'},
  {id:'google-gemini-workspace',name:'Google Gemini',listingUrl:'https://blog.google/products/gemini/',baseUrl:'https://blog.google',type:'company',scope:'international',tier:2,trustScore:97,enabled:true,description:'Gemini-nyheter som kan påverka Gmail, Docs, Drive och övriga Workspace-appar.'},
];
...
export const industryProfiles: IndustryProfile[] = [
  ...
  {id:'ai-tools',label:'AI-verktyg',description:'Produktförändringar i ChatGPT, Gemini, Claude, Copilot och Perplexity.',keywords:['chatgpt','openai','codex','gemini','google ai','claude','anthropic','copilot','perplexity','ai model','ai assistant','artificial intelligence','generative ai','agent','agents','modell','model','computer'],themes:['Produktlanseringar','Modeller','Integrationer','Pris & tillgång','Säkerhet'],sources:aiToolSources,suggestedCompetitors:[]},
  {id:'google-workspace',label:'Google Workspace',description:'Förändringar i Gmail, Drive, Docs, Sheets, Slides, Meet, Chat och Admin.',keywords:['google workspace','workspace','gmail','google drive','google docs','google sheets','google slides','google meet','google chat','workspace admin','apps script','gemini for workspace','gemini'],themes:['Nya funktioner','Administratör','Utrullning','Säkerhet','AI'],sources:googleWorkspaceSources,suggestedCompetitors:[]},
