...
export default function StrategicSignals(){
  ...
  return <section className="signalsPanel">
    ...
    {!data?.historyEnabled && <div className="signalEmpty"><TriangleAlert size={16}/><span>Historik krävs för riktiga signaler. {data?.reason ?? "Supabase är inte anslutet."}</span></div>}
