...
export default function IndustryFeed({industry,customIndustry,profile}:{industry:string;customIndustry?:string;profile:WatchProfile}){
 ...
 return <section className='industryFeed'>
  ...
  {data&&<section className='marketPulse'>
    <div className='marketPulseHead'><div><p className='eyebrow'><Activity size={14}/> MARKNADEN JUST NU</p><h3>Branschpuls senaste 7 dagarna</h3><p>En snabb bild av hur mycket som faktiskt händer innan Bevakly prioriterar och analyserar detaljerna.</p></div><span>{marketPulse.total} relevanta händelser</span></div>
